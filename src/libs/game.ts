...
// export const throwIfNotMap = (maybeMap, funcName) => {
...
//  */
// export const scale = (ledger, scale) => {
...
//  * @return {Boolean}
//  */
// export const inTheBlack = (ledger) => {
...
//  * @param {Array<immutable.Map>} ledgers
//  */
// export const totalOf = (currency, ...ledgers) => {
// 	if (!ledgers || ledgers.length === 0) {
// 		return 0;
// 	}
...
//  */
// export const buy = (item, wallet, state = {}) => {
// 	if (!item || !item.cost) {
// 		return wallet;
// 	}
...
// 	invariant(
// 		isFunc(item.cost),
// 		`The item of type: "${item.type}" has a cost attribute that is not a function.`,
// 	);
...
// 	invariant(
// 		Map.isMap(cost),
// 		`The item of type: "${item.type}" returns something other than an Immutable.js Map.`,
// 	);
...
//  * @param {Number} amount
//  */
// export const addItem = (item, wallet, amount = 1) => {
...
//  * @param {Object} state
//  */
// export const pouchEffectsLedger = (items, wallet, state = {}) => {
// 	const ledgers = items
// 		.map((item) => {
